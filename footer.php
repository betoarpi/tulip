                        ...
                        <svg viewBox="0 0 24 24">
                            ...
                            <g id="Layer_2" data-name="Layer 2">
                                <g id="Layer_1-2" data-name="Layer 1">
                                    <path
                                        d="M7.5 3h9A4.49 4.49 0 0121 7.5v9a4.49 4.49 0 01-4.5 4.5h-9A4.49 4.49 0 013 16.5v-9A4.49 4.49 0 017.5 3z"
                                        fill-rule="evenodd" stroke="#747489" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="1" fill="none"></path>
                                    <path class="cls-2"
                                        d="M8.12 11.1v5.4M11.72 16.5v-3.15A2.25 2.25 0 0114 11.1a2.25 2.25 0 012.25 2.25v3.15">
                                    </path>
                                    <path id="Shape_3077" data-name="Shape 3077" class="cls-2"
                                        d="M8.12 7.84a.23.23 0 10.22.22.22.22 0 00-.22-.22"></path>
                                    <path transform="rotate(-90 12 12)" fill="none" d="M0 0h24v24H0z"></path>
                                </g>
                            </g>
                        </svg>
                    </a>
                        ...
                        <svg viewBox="0 0 24 24">
                            <g data-name="Layer 2">
                                <g data-name="Layer 1" fill="none">
                                    <path
                                        d="M19.2 9.35c0 6.3-3.6 10.8-9.9 10.8-3.6 0-5-1.88-6.3-3.6m0 0l2.7-.9a8.33 8.33 0 01-.9-10.8 9.09 9.09 0 005.4 4.5 4.38 4.38 0 014.5-4.5 3.92 3.92 0 013.6 1.8H21l-1.8 2.7"
                                        stroke="#747489" stroke-linecap="round" stroke-linejoin="round" stroke-width="1"
